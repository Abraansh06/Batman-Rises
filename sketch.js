...
function preload(){
    ...
    batAnimation = loadAnimation("bat/bat1.png","bat/bat2.png","bat/bat3.png",
             ...
             mani= loadAnimation("Walking Frame/walking_1.png","Walking Frame/walking_2.png",
             ...
             bm=loadImage("Walking Frame/batman.png")
...
function setup(){
    ...
    man=createSprite(200,500,30,10);
    man.addAnimation("manvar",mani);
    man.addAnimation("bmvar",bm);
    man.scale=0.5
